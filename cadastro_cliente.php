                        ...
                        <div class="panel-body" >
                            <form id="signupform" name="cliente" class="form-horizontal" role="form" action="conexao.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="date" class="form-control" name="ncto">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select class="form-control" name="cidade">
                                          <option value="Maringa" selected>Maringa</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="renda">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        <input id="btn-signup" type="hidden" name="acao" value="inserir">
                                        <input type="submit" value="Cadastrar" name="enviar" class="btn btn-info">
                                    </div>
                                </div>
